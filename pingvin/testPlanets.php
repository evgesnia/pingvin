...
for($a=1;$a<=10;$a++){
$sql = "SELECT answer FROM `CorrectAnswersPlanets` WHERE (id= $a)";
...
$sql1 = "INSERT INTO `StudentsMarks` (login,mark,id_test) VALUES ('$login',$mark,1)";
$conn ->query( $sql1);
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="test.html">Тест1</a>
            </li>
            <li class="nav-item">
              <a class="nav-link " href="testgala.html">Тест2</a>
            </li>
